...
import {HealthScore} from './health_score.js';
  ...
  implements IContextMenu, IFocusableNode, IFocusableTree
{
  ...
  healthScore_: HealthScore | null = null;
   ...
   */
  addHealthScore() {
    this.healthScore_ = new HealthScore(this);
    const svgHealthScore = this.healthScore_.createDom();
    this.svgGroup_.appendChild(svgHealthScore);
  }
