  ...
  implements IContextMenu, IFocusableNode, IFocusableTree
{
  ...
  /**
   * Adds a mini map to the workspace.
   */
  addMiniMap() {
    this.miniMap_ = new MiniMap(this);
    const svgMiniMap = this.miniMap_.createDom();
    this.svgGroup_.appendChild(svgMiniMap);
  }
